...
cd company-data-go/examples/flow
go run .
```
...
[`https://portal.allus.fyi`](https://portal.allus.fyi)**. A physical phone with the
...
to reach the local API (e.g. `adb reverse tcp:8070 tcp:8070` on
